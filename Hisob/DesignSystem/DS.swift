...
extension DS {
    enum Palette {
        ...
        /// тот спорил и с синим остатка, и с фиолетовым переноса. Хрома
        /// намеренно занижена — на чистом чёрном насыщенный янтарь вибрировал
        /// и перетягивал внимание с сумм, ради которых сюда и заходят.
        /// По тону не пересекается ни с зелёным дохода, ни с красным расхода.
        static let brand = dynamic(light: 0x8A6A2F, dark: 0xC4A268)
