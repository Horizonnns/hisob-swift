...
struct LockScreen: View {
    ...
    var body: some View {
        ...
        // Проверку отсюда не запускаем. Этот экран появляется в том числе
        // когда приложение уходит в фон, и запрос Face ID из фона всплывал
        // потом на рабочем столе телефона. Кто и когда спрашивает — решает
        // `HisobApp`, он один знает, активна ли сцена.
    }
}
