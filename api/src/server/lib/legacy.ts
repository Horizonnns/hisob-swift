...
/**
 * Траты, которые не переносятся.
 *
 * Пусто намеренно: выгрузка переносится один в один. Записи, которые
 * в вебе были обходными приёмами, оказались настоящими деньгами —
 * исключать их значило бы завышать остаток.
 *
 * Оставлено как точка расширения на случай, если в будущем найдётся
 * запись, которую действительно нельзя переносить.
 */
