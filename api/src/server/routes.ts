...
/**
 * Навешивает все роуты на переданное приложение и возвращает его.
 *
 * Приложение создаётся не здесь, а в точке входа: Vercel ищет её по
 * признаку «файл импортирует `hono`», и создание `new Hono()` должно
